...
import { FaTrashAlt, FaEdit, FaImage, FaPlus, FaBars } from 'react-icons/fa';
import {
  Button,
  Heading,
  Paragraph,
...
import { IoMdImages, IoMdCalendar } from 'react-icons/io';
...
export function ResourcesManager() {
  ...
  return (
    <div className='space-y-2.5 lg:space-y-5'>
      {/* Header met nieuwe resource knop */}
      ...
      {/* Form voor nieuwe/bewerk resource */}
      {showForm && (
