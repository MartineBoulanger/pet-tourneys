...
import { getRules } from '@/actions/supabase/cms-schema/rules/getRules';
import { deleteRule } from '@/actions/supabase/cms-schema/rules/deleteRule';
import { reorderRules } from '@/actions/supabase/cms-schema/rules/updateRule';
...
export function RulesManager() {
  const {
    ...
    fetchFn: getRules,
    deleteFn: deleteRule,
    reorderFn: reorderRules,
    deleteConfirmMessage: 'Are you sure you want to delete this rule section?',
  });
              ...
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2.5 flex-1'>
                  ...
                  <div className='flex-1'>
                    ...
                    <div className='flex flex-wrap items-center gap-2.5 text-sm text-foreground/80'>
                      ...
                      {rule.createdat && (
                        <div className='flex items-center gap-1'>
                          <IoMdCalendar className='h-4 w-4' /> {rule.createdat}
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className='flex flex-col lg:flex-row gap-2.5 ml-2.5'>
                  ...
                  <Button
                    ...
                    disabled={deletingId === rule.id || showForm}
