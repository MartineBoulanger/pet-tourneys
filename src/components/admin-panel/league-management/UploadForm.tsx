...
import { uploadLog } from '@/actions/supabase/api-schema/matches/uploadLog';
import { updateMatchWithLogs } from '@/actions/supabase/api-schema/matches/updateMatch';
import { Form, Input, Textarea, Select, Option } from '@/components/ui';
import { UploadFormSkeleton } from '@/components/layout/Skeletons';
import { UploadFormProps } from '@/types/supabase.types';
      ...
      >
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-2.5'>
          ...
          >
            ...
            {leagues.map((league) => (
              <Option key={league.id} value={league.id} label={league.name} />
            ))}
          </Select>
          <Input
