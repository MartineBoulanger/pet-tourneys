...
import { deletePrize } from '@/actions/supabase/cms-schema/prizes/deletePrize';
import { reorderPrizes } from '@/actions/supabase/cms-schema/prizes/updatePrize';
...
export function PrizesManager() {
  const {
    ...
    fetchFn: getPrizes,
    deleteFn: deletePrize,
    reorderFn: reorderPrizes,
    deleteConfirmMessage: 'Are you sure you want to delete this prize section?',
  });
              ...
              <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2.5 flex-1'>
                  ...
                  <div className='flex-1'>
                    ...
                    <div className='flex flex-wrap items-center gap-2.5 text-sm text-foreground/80'>
                      ...
                      {prize.createdat && (
                        <div className='flex items-center gap-1'>
                          <IoMdCalendar className='h-4 w-4' /> {prize.createdat}
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className='flex flex-col lg:flex-row gap-2.5 ml-2.5'>
                  ...
                  <Button
                    ...
                    disabled={deletingId === prize.id || showForm}
