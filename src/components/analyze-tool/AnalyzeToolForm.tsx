...
import { BattleLog, LeaguePetData } from '@/types/supabase.types';
import { Form, Input, Textarea } from '@/components/ui';
import { AnalyzeToolFormSkeleton } from '@/components/layout/Skeletons';
...
export const AnalyzeToolForm = () => {
  ...
  const [parsedPetUsage, setParsedPetUsage] = useState<LeaguePetData[]>([]);
