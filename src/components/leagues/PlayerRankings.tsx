        ...
        <>
          ...
          <div className='space-y-2.5 bg-background p-2.5 rounded-lg shadow-md'>
            {currentRecords.map((player, index) => {
              ...
              const mostUsedPet = player.pets.find(
                (pet) => pet.name === player.mostUsedPet.petName,
              );
              const nemesisPet = player.pets.find(
                (pet) => pet.name === player.mostProblematicPet.petName,
              );
              const petDetails = player.pets.find(
                (pet) => pet.name === expandedPet,
              );
                                              ...
                                              <div>
                                                ...
                                                <div className='space-y-1 mt-2'>
                                                  ...
                                                  <Paragraph className='font-light'>
                                                    ...
                                                    {petDetails?.base_health}
                                                  </Paragraph>
                                                  <Paragraph className='font-light'>
                                                    <span className='font-bold'>
                                                      {'Base Power: '}
                                                    </span>
                                                    {petDetails?.base_power}
                                                  </Paragraph>
                                                  <Paragraph className='font-light'>
                                                    <span className='font-bold'>
                                                      {'Base Speed: '}
                                                    </span>
                                                    {petDetails?.base_speed}
                                                  </Paragraph>
                                                  <div className='absolute bottom-0 right-0 opacity-10 w-[150px] lg:w-[250px] h-[150px] lg:h-[250px]'>
                                                    <Image
                                                      src={
                                                        PET_TYPE_IMAGES[
                                                          petDetails?.type as keyof typeof PET_TYPE_IMAGES
                                                        ]
                                                      }
