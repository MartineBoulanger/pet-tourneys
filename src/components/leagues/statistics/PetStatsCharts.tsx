...
import {
  ...
  convertToGraphData,
} from '@/utils/supabase/parseAndAggregateStats';
import { COLORS, LeaguePetStat, ChartsProps } from '@/types/supabase.types';

export function PetStatsCharts({ data }: ChartsProps<LeaguePetStat>) {
  if (!data) {
    return (
