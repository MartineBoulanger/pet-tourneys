...
export const headerData: NavigationData = [
  {
    ...
    linkText: 'HomePage',
    text: '',
    imageSrc: `${process.env.BASE_URL!}/images/tourney-logo.png`,
  },
  {
    id: 2,
    url: '/tournaments',
    ...
    imageSrc: `${process.env.BASE_URL!}/images/redrex.png`,
    children: [
      {
        id: 1,
  ...
  },
  {
    ...
    imageSrc: `${process.env.BASE_URL!}/images/bluerex.png`,
  },
  {
    id: 4,
    url: '/articles',
    ...
    imageSrc: `${process.env.BASE_URL!}/images/greenrex.png`,
  },
  {
    id: 5,
    url: '/pet-reviews',
    ...
    imageSrc: `${process.env.BASE_URL!}/images/bluegor.png`,
  },
  {
    id: 6,
    url: '/analyze-tool',
    ...
    imageSrc: `${process.env.BASE_URL!}/images/greengor.png`,
  },
];
